...
test('should parse slashtags actions correctly', (t) => {
  const url =
    'slashtags:b2iaqaamaaqjcbw7zetxujobillqlmizi6uroscubpzsb72xzmisfcq7fhbg27xbm/path/just/to/be/sure/#ugAR7ImNoYWxsZW5nZSI6ImZvbyIsImNiVVJMIjoiaHR0cHM6d3d3LmV4YW1wbGUuY29tIn0'
  ...
  t.deepEqual(parsed, {
    ...
    protocol: PROTOCOL_NAME,
    actionID:
      'b2iaqaamaaqjcbw7zetxujobillqlmizi6uroscubpzsb72xzmisfcq7fhbg27xbm',
    payload: {
      challenge: 'foo',
...
test('should remove any additional fields', (t) => {
  ...
  const url =
    'slashtags:b2iaqaamaaqjcbw7zetxujobillqlmizi6uroscubpzsb72xzmisfcq7fhbg27xbm/path/just/to/be/sure/#' +
    payload
